<div class="flex min-w-0" x-data="{ open: @entangle('open').defer }">
    <button type="button" title="Pesquisa" x-on:click="open = true; $nextTick(() => searchInput.focus())"
        class="menu-item">
        <svg class="w-8 min-w-8" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
    ...
    <div x-show.transition.opacity="open" x-on:keydown.escape="$wire.close()"
